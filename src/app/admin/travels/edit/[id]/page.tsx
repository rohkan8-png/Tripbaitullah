    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        setFormData({
          ...
          gallery: travel.gallery ? JSON.parse(travel.gallery).join(', ') : '',
        ...
        if (travel.gallery) {
          const galleryArray = JSON.parse(travel.gallery)
          setGalleryPreviews(galleryArray)
        }
      }
    } catch (error) {
        ...
        <Card className="p-6">
          ...
          <div>
            <label
              ...
              className="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-primary hover:bg-gray-50 transition-colors mb-4"
            >
              <div className="text-center">
                <p className="text-sm text-gray-600">
