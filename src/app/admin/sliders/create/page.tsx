  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        alert('Gagal menambahkan slider: ' + result.error)
      }
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Tambah Slider</h1>
          <p className="text-gray-600">Tambahkan slider banner baru</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600 mb-1">
                    {imageFile ? imageFile.name : 'Klik untuk upload gambar slider'}
                  </p>
        ...
        <div className="flex items-center justify-end gap-4">
          ...
          >
            ...
            {uploading ? 'Mengupload...' : loading ? 'Menyimpan...' : 'Simpan Slider'}
          </Button>
        </div>
      </form>
    </div>
