    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        setFormData({
          ...
          quota: pkg.quota || 45,
          quotaAvailable: pkg.quotaAvailable || 45,
          category: pkg.category || 'premium',
        ...
        if (pkg.priceOptions && pkg.priceOptions.length > 0) {
          setPriceOptions(pkg.priceOptions)
        }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Update data paket umroh</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Price Options - Continue in next part */}
        ...
        <div className="flex items-center justify-end gap-4">
          ...
          <Button type="submit" className="bg-primary hover:bg-primary/90" disabled={loading || uploading}>
            ...
            {uploading ? 'Mengupload...' : loading ? 'Menyimpan...' : 'Update Paket'}
          </Button>
        </div>
      </form>
    </div>
